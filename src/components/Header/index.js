                                ...
                                </button>
                                {
                                    currentUser ?
                                        <ul className="dropdown-menu dropdown-menu-end bg-less-dark text-light border-light">
                                            ...
                                            <li>
                                                <Link className="dropdown-item text-light" to="/" onClick={() => {
                                                    dispatch({
                                                        type: UPDATE_PAGE,
                                                        page: "Dashboard"
                                                    })
                                            ...
                                            <li>
                                                <Link className="dropdown-item text-light" to="/update-profile" onClick={() => {
                                                    dispatch({
                                                        type: UPDATE_PAGE,
                                                        page: "Update Profile"
                                                    })
                                            ...
                                            <li><hr className="dropdown-divider border-light" /></li>
                                            <li><Link className={`dropdown-item text-light`} to="/" onClick={() => {
                                                dispatch({
                                                    type: UPDATE_PAGE,
                                                    page: "Sign In"
                                                })
                                        ...
                                        <ul className="dropdown-menu dropdown-menu-end bg-less-dark text-light">
                                            <li><Link className="dropdown-item text-light" to="/signin" onClick={() => {
                                                dispatch({
                                                    type: UPDATE_PAGE,
                                                    page: "Sign In"
                                                })
                                            ...
                                            <li><Link className="dropdown-item text-light" to="/signup" onClick={() => {
                                                dispatch({
                                                    type: UPDATE_PAGE,
                                                    page: "Sign Up"
                                                })
